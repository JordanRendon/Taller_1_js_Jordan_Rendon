...
alert('Por favor ingrese la siguiente informacion para saber si gano o no una beca')
...
if ( edad >= 18) {
    if(promedio >= 9) {
        ...
        alert('Te invitamos a estudiar mas en el proxima ciclo escolar')
    }
